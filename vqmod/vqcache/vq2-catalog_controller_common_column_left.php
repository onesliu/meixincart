...
//OMF start
			...
			if ($modules) {
				foreach ($modules as $module) {
					//OMF start
						if ($module['layout_id'] == $layout_id && $module['position'] == 'column_left' && $module['status'] && $isMobileExtension) { //load only mobile extensions
							$module_data[] = array(
								'code'       => $extension['code'],
								'setting'    => $module,
				...
				if ($modules) {
					foreach ($modules as $module) {
						if ($module['layout_id'] == $layout_id && $module['position'] == 'column_left' && $module['status'] && !$isMobileExtension) { //omitting the mobile ones
							$module_data[] = array(
								'code'       => $extension['code'],
								'setting'    => $module,
								'sort_order' => $module['sort_order']

<?php  
class ControllerMobileStoreContentBottom extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/content_bottom.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/mobile_store/content_bottom.tpl';
		} else {
			$this->template = 'default/template/mobile_store/content_bottom.tpl';
		}

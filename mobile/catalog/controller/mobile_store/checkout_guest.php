<?php 
class ControllerMobileStoreCheckoutGuest extends Controller {
  	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/checkout_guest.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/mobile_store/checkout_guest.tpl';
		} else {
			$this->template = 'default/template/mobile_store/checkout_guest.tpl';
		}

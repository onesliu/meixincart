<?php 
class ControllerMobileStoreCheckoutGuestShipping extends Controller {
  	public function index() {	
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/checkout_guest_shipping.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/mobile_store/checkout_guest_shipping.tpl';
		} else {
			$this->template = 'default/template/mobile_store/checkout_guest_shipping.tpl';
		}		

<?php 
class ControllerMobileStoreAddress extends Controller {
	private $error = array();
	  
  	public function index() {
    	if (!$this->customer->isLogged()) {
	  		$this->session->data['redirect'] = $this->url->link('mobile_store/address', '', 'SSL');
  	...
  	public function insert() {
    	...
    	if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validateForm()) {
			$this->model_account_address->addAddress($this->request->post);
	  		...
	  		$this->redirect($this->url->link('mobile_store/address', '', 'SSL'));
    	} 
  	...
  	private function getList() {
      	...
      	$this->data['breadcrumbs'][] = array(
			...
			'href'      => $this->url->link('mobile_store/account', '', 'SSL'),
        	'separator' => $this->language->get('text_separator')
      	);

      	$this->data['breadcrumbs'][] = array(
        	'text'      => $this->language->get('heading_title'),
			'href'      => $this->url->link('mobile_store/address', '', 'SSL'),
        	'separator' => $this->language->get('text_separator')
      	);
    	...
    	foreach ($results as $result) {
			...
			$replace = array(
      		...
      		$this->data['addresses'][] = array(
        		...
        		'update'     => $this->url->link('mobile_store/address/update', 'address_id=' . $result['address_id'], 'SSL'),
				'delete'     => $this->url->link('mobile_store/address/delete', 'address_id=' . $result['address_id'], 'SSL')
      		);
    	}

    	$this->data['insert'] = $this->url->link('mobile_store/address/insert', '', 'SSL');
		$this->data['back'] = $this->url->link('mobile_store/account', '', 'SSL');
				
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/address_list.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/mobile_store/address_list.tpl';
		} else {
			$this->template = 'default/template/mobile_store/address_list.tpl';
		}
  	...
  	private function getForm() {
		...
		if (!isset($this->request->get['address_id'])) {
      		$this->data['breadcrumbs'][] = array(
				...
				'href'      => $this->url->link('mobile_store/address/insert', '', 'SSL'),       		
        		'separator' => $this->language->get('text_separator')
      		);
		} else {
      		$this->data['breadcrumbs'][] = array(
        		'text'      => $this->language->get('text_edit_address'),
				'href'      => $this->url->link('mobile_store/address/update', 'address_id=' . $this->request->get['address_id'], 'SSL'),       		
        		'separator' => $this->language->get('text_separator')
      		);
		}
		...
		if (!isset($this->request->get['address_id'])) {
    		$this->data['action'] = $this->url->link('mobile_store/address/insert', '', 'SSL');
		} else {
    		$this->data['action'] = $this->url->link('mobile_store/address/update', 'address_id=' . $this->request->get['address_id'], 'SSL');
		}
    	...
    	$this->data['back'] = $this->url->link('mobile_store/address', '', 'SSL');
		
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/address_form.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/mobile_store/address_form.tpl';
		} else {
			$this->template = 'default/template/mobile_store/address_form.tpl';
		}

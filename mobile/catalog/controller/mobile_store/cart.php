<?php 
class ControllerMobileStoreCart extends Controller {
	private $error = array();
	...
	public function index() {
    	...
    	if ($this->cart->hasProducts() || !empty($this->session->data['vouchers'])) {
			...
			if ($this->config->get('config_customer_price') && !$this->customer->isLogged()) {
				$this->data['attention'] = sprintf($this->language->get('text_login'), $this->url->link('mobile_store/login'), $this->url->link('mobile_store/register'));
			} else {
				$this->data['attention'] = '';
			}
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/cart.tpl')) {
				...
				$this->template = 'default/template/mobile_store/cart.tpl';
			}
	...
	public function add() {
		...
		if ($product_info) {			
			...
			if (!$json) {
				...
				$json['success'] = sprintf($this->language->get('text_success'), $this->url->link('mobile_store/product', 'product_id=' . $this->request->post['product_id']), $product_info['name'], $this->url->link('mobile_store/cart'));
	...
	public function quote() {
		...
		if (!$this->cart->hasShipping()) {
			$json['error']['warning'] = sprintf($this->language->get('error_no_shipping'), $this->url->link('mobile_store/contact'));				
		}				

...
<div id="shipping-new" style="display: none;">
  <table class="form">
    ...
    <tr>
      ...
      <td><select name="country_id" class="large-field" onchange="$('#shipping-address select[name=\'zone_id\']').load('index.php?route=mobile_store/checkout_shipping_address/zone&country_id=' + this.value);">
...
$('#shipping-address select[name=\'zone_id\']').load('index.php?route=mobile_store/checkout_shipping_address/zone&country_id=<?php echo $country_id; ?>');

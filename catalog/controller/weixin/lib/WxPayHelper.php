...
class WxPayHelper
{
	...
	protected function get_cft_package(){
		try {
			...
			if (null == $this->wxconfig->partnerkey || "" == $this->wxconfig->partnerkey ) {
			...
			return $paraString . "&sign=" . $md5SignUtil->sign($unSignParaString,$commonUtil->trimString($this->wxconfig->partnerkey));

<?php 
class ControllerMobileStoreReward extends Controller {
	public function index() {
		...
		if ($points && $points_total && $this->config->get('reward_status')) {
			...
			if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/reward.tpl')) {
				$this->template = $this->config->get('config_template') . '/template/mobile_store/reward.tpl';
			} else {
				$this->template = 'default/template/mobile_store/reward.tpl';
			}

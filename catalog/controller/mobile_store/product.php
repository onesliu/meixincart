<?php  
class ControllerMobileStoreProduct extends Controller {
	private $error = array(); 
	...
	public function index() { 
		...
		if ($product_info) {
			...
			$this->data['ps_galery_height'] = $this->config->get('mobile_store_image_height') + 2;
	...
	public function review() {
		...
		$pagination->url = $this->url->link('mobile_store/product/review', 'product_id=' . $this->request->get['product_id'] . '&page={page}');
			
		$this->data['pagination'] = $pagination->render();
		
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/review.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/mobile_store/review.tpl';
		} else {
			$this->template = 'default/template/mobile_store/review.tpl';
		}

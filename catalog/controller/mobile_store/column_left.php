<?php  
class ControllerMobileStoreColumnLeft extends Controller {
	public function index() {
		...
		if (file_exists(DIR_TEMPLATE . $this->config->get('config_template') . '/template/mobile_store/column_left.tpl')) {
			$this->template = $this->config->get('config_template') . '/template/mobile_store/column_left.tpl';
		} else {
			$this->template = 'default/template/mobile_store/column_left.tpl';
		}

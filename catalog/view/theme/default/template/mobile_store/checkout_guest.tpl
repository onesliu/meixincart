...
<div class="right">
  ...
  <select name="country_id" class="large-field" onchange="$('#payment-address select[name=\'zone_id\']').load('index.php?route=mobile_store/checkout_guest/zone&country_id=' + this.value);">
...
$('#payment-address select[name=\'zone_id\']').load('index.php?route=mobile_store/checkout_guest/zone&country_id=<?php echo $country_id; ?>&zone_id=<?php echo $zone_id; ?>');
//--></script> 
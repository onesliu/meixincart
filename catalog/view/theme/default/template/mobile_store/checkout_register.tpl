...
<div class="right">
  ...
  <select name="country_id" class="large-field" onchange="$('#payment-address select[name=\'zone_id\']').load('index.php?route=mobile_store/checkout_register/zone&country_id=' + this.value);">
...
$('#payment-address select[name=\'zone_id\']').load('index.php?route=mobile_store/checkout_register/zone&country_id=<?php echo $country_id; ?>');
//--></script> 
<script type="text/javascript"><!--
$('.colorbox').colorbox({
	width: 560,

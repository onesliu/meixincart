<div>
  ...
  <div class="cart-content">
    ...
    <table id="shipping">
      ...
      <tr><td><span class="required">*</span> <?php echo $entry_postcode; ?></td></td>
      <tr>  
		<td><input class="maximize" type="text" name="postcode" value="<?php echo $postcode; ?>" /></td>
      </tr>
    </table>
...
$('#button-quote').bind('click', function() {
	$.ajax({
		type: 'POST',
		url: 'index.php?route=mobile_store/shipping/quote',
...
$('#button-shipping').live('click', function() {
	$.ajax({
		type: 'POST',
		url: 'index.php?route=mobile_store/shipping/calculate',
...
//--></script> 
<script type="text/javascript"><!--
$('select[name=\'zone_id\']').load('index.php?route=mobile_store/shipping/zone&country_id=<?php echo $country_id; ?>&zone_id=<?php echo $zone_id; ?>');
//--></script> 
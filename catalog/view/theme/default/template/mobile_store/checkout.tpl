...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_login',
		dataType: 'html',
...
$(document).ready(function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_payment_address',
		dataType: 'html',
		success: function(html) {
...
$('#button-account').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_' + $('input[name=\'account\']:checked').attr('value'),
		dataType: 'html',
		beforeSend: function() {
...
$('#button-login').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_login/validate',
		type: 'post',
...
$('#button-register').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_register/validate',
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				if (shipping_address) {
					$.ajax({
						url: 'index.php?route=mobile_store/checkout_shipping_method',
						dataType: 'html',
						success: function(html) {
							...
							$.ajax({
								url: 'index.php?route=mobile_store/checkout_shipping_address',
								dataType: 'html',
								success: function(html) {
				...
				<?php } else { ?>
				$.ajax({
					url: 'index.php?route=mobile_store/checkout_payment_method',
					dataType: 'html',
					success: function(html) {
...
$('#button-payment-address').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_payment_address/validate',
		type: 'post',
		data: $('#payment-address input[type=\'text\'], #payment-address input[type=\'password\'], #payment-address input[type=\'checkbox\']:checked, #payment-address input[type=\'radio\']:checked, #payment-address input[type=\'hidden\'], #payment-address select'),
		dataType: 'json',
		beforeSend: function() {
...
$('#button-shipping-address').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_shipping_address/validate',
		type: 'post',
...
$('#button-guest').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_guest/validate',
		type: 'post',
				...
				if (shipping_address) {
					$.ajax({
						...
						success: function(html) {
							...
							$.ajax({
								url: 'index.php?route=mobile_store/checkout_guest_shipping',
								dataType: 'html',
								success: function(html) {
									$('#shipping-address .checkout-content').html(html);
								},
...
$('#button-guest-shipping').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_guest_shipping/validate',
		type: 'post',
...
$('#button-shipping-method').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_shipping_method/validate',
		type: 'post',
...
$('#button-payment-method').live('click', function() {
	$.ajax({
		url: 'index.php?route=mobile_store/checkout_payment_method/validate', 
		type: 'post',
		...
		success: function(json) {
			...
			if (json['error']) {
				...
				$.ajax({
					url: 'index.php?route=mobile_store/checkout_confirm',
					dataType: 'html',
					success: function(html) {

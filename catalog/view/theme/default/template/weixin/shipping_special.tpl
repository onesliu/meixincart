	...
	<div data-role="content">
		...
		<div class="ui-body line-box">
			...
			<div style="width:75%;float:left;">
    			<button class="ui-btn ui-btn-icon-notext ui-icon-minus ui-btn-inline ui-corner-all ui-nodisc-icon"
    				style="margin:0 1em;" onclick="changecount(-1);"></button>
  				<span id="pcount" style="border:solid 1px #eeeeee;padding:.2em .6em">1</span>
  				<button class="ui-btn ui-btn-icon-notext ui-icon-plus ui-btn-inline ui-corner-all ui-nodisc-icon"
  					style="margin:0 1em;" onclick="changecount(1);"></button>
  			</div>
		</div>
